                   ...
                   @foreach($languages as $key=>$lang)
                       <div class="tab-pane @if($key==0) active show @endif " id="post-recent-{{$lang}}" role="tabpanel">
                           ...
                           <div class="mb-3 row">
                               ...
                               <div class="col-md-10">
                                   <input value="{{$ourstory->translate($lang)?->title}}" class="form-control" name="title[{{$lang}}]" value="" type="text" id="example-search-input">
                                   @error('title.'.$lang)
                           ...
                           <div class="mb-3 row">
                               ...
                               <div class="col-md-10">
                                   <input value="{{$ourstory->translate($lang)?->url}}" class="form-control" name="url[{{$lang}}]" value="" type="text" id="example-search-input">
                                   @error('url.'.$lang)
                                   <div class="text-danger mt-2">{{$message}}</div>
                                   @enderror
                               </div>
                           ...
                           <div class="mb-3 row">
                               ...
                               <div class="col-md-10">
                                   <textarea name="content[{{$lang}}]" id="editor1" class="ckeditor" rows="10" cols="80">{{$ourstory->translate($lang)?->content}}</textarea>
                                   @error('content.'.$lang)
                                   <div class="text-danger mt-2">{{$message}}</div>
                                   @enderror
                               </div>
                           ...
                           <div class="mb-3 row">
                               ...
                               <div class="col-md-10">
                                   <div class="form-check mb-3">
                                       <input @checked($ourstory->translate($lang)?->status==1)  class="form-check-input" type="radio" name="status[{{$lang}}]" value="1" id="formRadios1" checked="">
                                       <label class="form-check-label" for="formRadios1">
                                           Aktiv
                                       </label>
                                   </div>
                                   <div class="form-check">
                                       <input @checked($ourstory->translate($lang)?->status==0)  class="form-check-input" type="radio" name="status[{{$lang}}]" value="0" id="formRadios2">
                   ...
                   @endforeach
                       ...
                       <div class="mb-3 row">
                           ...
                           <div class="col-md-10">
                               ...
                               <input value="{{$ourstory->order}}" name="order" class="form-control form-control-lg" id="formFileLg" type="number">
                       ...
                       <div class="col-md-10">
                           ...
                           <img width="400" class="my-4" src="/storage/ourstory/{{$ourstory->image}}" alt="">
                           @error('image')
                           <div class="text-danger mt-2">{{$message}}</div>
                           @enderror
