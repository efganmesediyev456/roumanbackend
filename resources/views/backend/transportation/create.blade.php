                   ...
                   @foreach($languages as $key=>$lang)
                       <div class="tab-pane @if($key==0) active show @endif " id="post-recent-{{$lang}}" role="tabpanel">
                           ...
                           <div class="mb-3 row">
                               ...
                               <div class="col-md-10">
                                   <input class="form-control" name="title1[{{$lang}}]" value="" type="text" id="example-search-input">
                                   @error('title1.'.$lang)
                           ...
                           <div class="mb-3 row">
                               ...
                               <div class="col-md-10">
                                   <input class="form-control" name="title5[{{$lang}}]" value="" type="text" id="example-search-input">
                                   @error('title5.'.$lang)
                                   <div class="text-danger mt-2">{{$message}}</div>
                                   @enderror
                               </div>
