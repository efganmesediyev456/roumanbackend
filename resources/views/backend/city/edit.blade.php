                                            ...
                                            <div class="tab-content">
                                                @foreach(['az','en','ru'] as $key=>$lang)
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input value="{{$city->translate($lang)?->title}}" class="form-control" name="title[{{$lang}}]" value="{{old('title.'.$lang)}}" type="search"  id="example-search-input">
                                                  ...
                                                  <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-10">
                                                        ...
                                                        <input @checked($city->translate($lang)?->status==1) class="form-check-input" type="radio" name="status[{{$lang}}]" value="1" id="formRadios1" >
                                                        <label class="form-check-label" for="formRadios1">
                                                            Aktiv
                                                        </label>
                                                    </div>
                                                        <div class="form-check">
                                                        <input @checked($city->translate($lang)?->status==0)   class="form-check-input" type="radio" name="status[{{$lang}}]" value="0" id="formRadios2" >
