                   ...
                   @foreach($languages as $key=>$lang)
                       <div class="tab-pane @if($key==0) active show @endif " id="post-recent-{{$lang}}" role="tabpanel">
                           ...
                           <div class="mb-3 row">
                               ...
                               <div class="col-md-10">
                                   <input class="form-control" value="{{$blogcategory->translate($lang)?->title}}" name="title[{{$lang}}]" value="" type="text" id="example-search-input">
                                   @error('title.'.$lang)
                           ...
                           <div class="mb-3 row">
                               ...
                               <div class="col-md-10">
                                   <div class="form-check mb-3">
                                       <input @selected($blogcategory->translate($lang)?->status==1)  class="form-check-input" type="radio" name="status[{{$lang}}]" value="1" id="formRadios1" checked="">
                                       <label class="form-check-label" for="formRadios1">
                                           Aktiv
                                       </label>
                                   </div>
                                   <div class="form-check">
                                       <input @selected($blogcategory->translate($lang)?->status==0) class="form-check-input" type="radio" name="status[{{$lang}}]" value="0" id="formRadios2">
                   ...
                   @endforeach
                       ...
                       <div class="mb-3 row">
                           ...
                           <div class="col-md-10">
                               ...
                               <input value="{{$blogcategory->order}}" name="order" class="form-control form-control-lg" id="formFileLg" type="number">
