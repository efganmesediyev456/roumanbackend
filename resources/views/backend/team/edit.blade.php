                ...
                <div class="tab-content">
                    @foreach($languages as $key=>$lang)
                        <div class="tab-pane @if($key==0) active show @endif " id="post-recent-{{$lang}}" role="tabpanel">
                            ...
                            <div class="mb-3 row">
                                <label for="example-search-input" class="col-md-2 col-form-label">Name {{$lang}}</label>
                                <div class="col-md-10">
                                    <input class="form-control" value="{{$team->translate($lang)?->name}}" name="name[{{$lang}}]" value="" type="text" id="example-search-input">
                                    @error('name.'.$lang)
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" value="{{$team->translate($lang)?->position}}" name="position[{{$lang}}]" value="" type="text" id="example-search-input">
                                    @error('position.'.$lang)
                                    <div class="text-danger mt-2">{{$message}}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-check mb-3">
                                        <input @checked($team->translate($lang)?->status==1)  class="form-check-input" type="radio" name="status[{{$lang}}]" value="1" id="formRadios1">
                                        <label class="form-check-label" for="formRadios1">
                                            Aktiv
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input @checked($team->translate($lang)?->status==0) class="form-check-input" type="radio" name="status[{{$lang}}]" value="0" id="formRadios2">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            ...
                            <input name="order" value="{{$team->order}}" class="form-control form-control-lg" id="formFileLg" type="number">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            ...
                            <a href="/storage/team/{{$team->image}}" target="_blank"><img width="400px" class="my-4" src="/storage/team/{{$team->image}}"></a>
                            @error('image')
                            <div class="text-danger mt-2">{{$message}}</div>
                            @enderror
