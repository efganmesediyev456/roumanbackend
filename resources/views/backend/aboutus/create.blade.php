                   ...
                   @foreach($languages as $key=>$lang)
                       <div class="tab-pane @if($key==0) active show @endif " id="post-recent-{{$lang}}" role="tabpanel">
                           ...
                           <div class="mb-3 row">
                               ...
                               <div class="col-md-10">
                                   <input class="form-control" name="explore[{{$lang}}]" value="" type="text" id="example-search-input">
                                   @error('explore.'.$lang)
                                   <div class="text-danger mt-2">{{$message}}</div>
                                   @enderror
                               </div>
                           ...
                           <div class="mb-3 row">
                               ...
                               <div class="col-md-10">
                                   <input class="form-control" name="explore_text[{{$lang}}]" value="" type="text" id="example-search-input">
                           ...
                           <div class="mb-3 row">
                               ...
                               <div class="col-md-10">
                                   <input class="form-control" name="about_us_link[{{$lang}}]" value="" type="text" id="example-search-input">
