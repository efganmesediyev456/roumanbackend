                   ...
                   @foreach($languages as $key=>$lang)
                       <div class="tab-pane @if($key==0) active show @endif " id="post-recent-{{$lang}}" role="tabpanel">
                           ...
                           <div class="mb-3 row">
                               ...
                               <div class="col-md-10">
                                   <input value="{{$rent->translate($lang)?->title}}" class="form-control" name="title[{{$lang}}]" value="" type="text" id="example-search-input">
                                   @error('title.'.$lang)
                           ...
                           <div class="mb-3 row">
                               ...
                               <div class="col-md-10">
                                   <input value="{{$rent->translate($lang)?->title2}}" class="form-control" name="title2[{{$lang}}]" value="" type="text" id="example-search-input">
                                   @error('title2.'.$lang)
                                   <div class="text-danger mt-2">{{$message}}</div>
                                   @enderror
                               </div>
                           ...
                           <div class="mb-3 row">
                               ...
                               <div class="col-md-10">
                                   <input value="{{$rent->translate($lang)?->title3}}" class="form-control" name="title3[{{$lang}}]" value="" type="text" id="example-search-input">
                                   @error('title3.'.$lang)
                                   <div class="text-danger mt-2">{{$message}}</div>
                                   @enderror
                               </div>
                           ...
                           <div class="mb-3 row">
                               ...
                               <div class="col-md-10">
                                   <input value="{{$rent->translate($lang)?->title4}}" class="form-control" name="title4[{{$lang}}]" value="" type="text" id="example-search-input">
                                   @error('title4.'.$lang)
                                   <div class="text-danger mt-2">{{$message}}</div>
                                   @enderror
                               </div>
                           ...
                           <div class="mb-3 row">
                               ...
                               <div class="col-md-10">
                                   <input class="form-control" value="{{$rent->translate($lang)?->price_detail}}" name="price_detail[{{$lang}}]" value="" type="text" id="example-search-input">
                           ...
                           <div class="mb-3 row">
                               ...
                               <div class="col-md-10">
                                   <div class="form-check mb-3">
                                       <input @selected($rent->translate($lang)?->status==1)  class="form-check-input" type="radio" name="status[{{$lang}}]" value="1" id="formRadios1" checked="">
                                       <label class="form-check-label" for="formRadios1">
                                           Aktiv
                                       </label>
                                   </div>
                                   <div class="form-check">
                                       <input @selected($rent->translate($lang)?->status==0)  class="form-check-input" type="radio" name="status[{{$lang}}]" value="0" id="formRadios2">
                   ...
                   @endforeach
                       ...
                       <div class="mb-3 row">
                           ...
                           <div class="col-md-10">
                               ...
                               <input value="{{$rent->order}}" name="order" class="form-control form-control-lg" id="formFileLg" type="number">
                           ...
                           <div class="col-md-10">
                               ...
                               <select name="rent_category_id" class="form-control form-control-lg" id="formFileLg" type="number">
                                   @foreach($rentcategories as $category)
                                       <option @selected($rent->rent_category_id==$category->id) value="{{$category->id}}">{{$category->title}}</option>
                                       @endforeach
                               </select>
                       ...
                       <div class="col-md-10">
                           ...
                           <img src="/storage/rent/{{$rent->image}}" width="400" alt="">
                           @error('image')
                           <div class="text-danger mt-2">{{$message}}</div>
                           @enderror
