                ...
                <div class="tab-content">
                    @foreach($languages as $key=>$lang)
                        <div class="tab-pane @if($key==0) active show @endif " id="post-recent-{{$lang}}" role="tabpanel">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" name="position[{{$lang}}]" value="" type="text" id="example-search-input">
                                    @error('position.'.$lang)
                                    <div class="text-danger mt-2">{{$message}}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" name="subtitle[{{$lang}}]" value="" type="text" id="example-search-input">
                                    @error('subtitle.'.$lang)
                                    <div class="text-danger mt-2">{{$message}}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" name="number" value="" type="text" id="example-search-input">
                                @error('number')
                                <div class="text-danger mt-2">{{$message}}</div>
                                @enderror
                            </div>
